...
def visualize_flow(flow, add,  mode='Y'):
    """
...
#b = np.fromfile('test.mv', dtype=np.int32)
#b = np.reshape(b, a.shape)
#visualize_flow(a, 'org.jpg')
#visualize_flow(b, 'cur.jpg')
